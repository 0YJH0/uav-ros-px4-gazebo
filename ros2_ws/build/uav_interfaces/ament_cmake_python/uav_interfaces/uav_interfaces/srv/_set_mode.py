...
class SetMode_Event(metaclass=Metaclass_SetMode_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<uav_interfaces/SetMode_Request, 1>',
        'response': 'sequence<uav_interfaces/SetMode_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['uav_interfaces', 'srv'], 'SetMode_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['uav_interfaces', 'srv'], 'SetMode_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from uav_interfaces.srv import SetMode_Request
    ...
    def response(self, value):
        if self._check_fields:
            from uav_interfaces.srv import SetMode_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SetMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from uav_interfaces.srv import _set_mode
...
class SetMode(metaclass=Metaclass_SetMode):
    from uav_interfaces.srv._set_mode import SetMode_Request as Request
    from uav_interfaces.srv._set_mode import SetMode_Response as Response
    from uav_interfaces.srv._set_mode import SetMode_Event as Event
